...
def analyze_video(transcript: str) -> AnalysisResult:
    """Analyze a video transcript with Claude. Returns summary + stock mentions."""
    ...
    response = client.messages.create(
        ...
        max_tokens=2048,
        messages=[{"role": "user", "content": PROMPT_TEMPLATE.format(transcript=truncated)}],
    )
    ...
    return AnalysisResult(summary=data.get("summary", ""), stocks=stocks)
